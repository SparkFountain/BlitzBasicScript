  ...
  public async executeCommand(command: CommandStatement): Promise<any> {
    ...
    switch (cmdLower) {
      ...
      case 'collisiontriangle':
        return this.graphics3d.collisionTriangle(evaluatedParams[0], evaluatedParams[1]);
      case 'collisionx':
        return this.graphics3d.collisionX(evaluatedParams[0], evaluatedParams[1]);
      case 'collisiony':
        return this.graphics3d.collisionY(evaluatedParams[0], evaluatedParams[1]);
      case 'collisionz':
        return this.graphics3d.collisionZ(evaluatedParams[0], evaluatedParams[1]);
      ...
      case 'entitycollided':
        return this.graphics3d.entityCollided(evaluatedParams[0], evaluatedParams[1]);
      case 'entityradius':
        return this.graphics3d.entityRadius(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'entitytype':
        return this.graphics3d.entityType(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'getentitytype':
        return this.graphics3d.getEntityType(evaluatedParams[0]);
      case 'meshesintersect':
        return this.graphics3d.meshesIntersect(evaluatedParams[0], evaluatedParams[1]);
      case 'resetentity':
      ...
      case 'entityorder':
        return this.graphics3d.entityOrder(evaluatedParams[0], evaluatedParams[1]);
      case 'entityparent':
        return this.graphics3d.entityParent(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'entityshininess':
        return this.graphics3d.entityShininess(evaluatedParams[0], evaluatedParams[1]);
      case 'entitytexture':
      ...
      case 'getmatelement':
        return this.graphics3d.getMatElement(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'loadermatrix':
      ...
      case 'vectorpitch':
        return this.graphics3d.vectorPitch(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'vectoryaw':
        return this.graphics3d.vectorYaw(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      ...
      case 'clearsurface':
        return this.graphics3d.clearSurface(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'countsurfaces':
      ...
      case 'createsurface':
        return this.graphics3d.createSurface(evaluatedParams[0], evaluatedParams[1]);
      case 'findsurface':
        return this.graphics3d.findSurface(evaluatedParams[0], evaluatedParams[1]);
      case 'getsurface':
        return this.graphics3d.getSurface(evaluatedParams[0], evaluatedParams[1]);
      case 'trianglevertex':
        return this.graphics3d.triangleVertex(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'updatenormals':
        return this.graphics3d.updateNormals(evaluatedParams[0]);
      case 'vertexalpha':
        return this.graphics3d.vertexAlpha(evaluatedParams[0], evaluatedParams[1]);
      case 'vertexblue':
        return this.graphics3d.vertexBlue(evaluatedParams[0], evaluatedParams[1]);
      case 'vertexcolor':
      ...
      case 'vertexgreen':
        return this.graphics3d.vertexGreen(evaluatedParams[0], evaluatedParams[1]);
      case 'vertexnormal':
      ...
      case 'vertexred':
        return this.graphics3d.vertexRed(evaluatedParams[0], evaluatedParams[1]);
      ...
      case 'vertexu':
        return this.graphics3d.vertexU(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'vertexv':
        return this.graphics3d.vertexV(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'vertexw':
        return this.graphics3d.vertexW(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'vertexx':
      ...
      case 'movemouse':
        return this.io.moveMouse(evaluatedParams[0], evaluatedParams[1], evaluatedParams[2]);
      case 'showpointer':
